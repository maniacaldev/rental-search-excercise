...
return $(".loader-wrap").remove(),$("#results").empty(),$("#results").append('<div class="search-criteria group"><p><strong>Your Search</strong><span><span>Location</span> '+a+" &nbsp;&nbsp;<span>Pick-up Date</span> "+b+" &nbsp;&nbsp;<span>Drop-off Date</span> "+c+"</p></span></div>"),d.hasOwnProperty("Result")?($.each(d.Result,function(a,b){$("#results").append('<div class="result" data-id="'+b.ResultId+'" data-ref="'+b.HWRefNumber+'" data-car-type-code="'+b.CarTypeCode+'"><div class="result-col result-image-col"><img class="result-image" src="/dist/svg/cars/'+b.CarTypeCode+'.svg" alt="'+b.CarTypeCode+'"></div><div class="result-col"><p><strong>Daily Rate:</strong> $'+b.DailyRate+"</p><p><strong>Subtotal:</strong> $"+b.SubTotal+"</p><p><strong>Taxes/Fees</strong>: $"+b.TaxesAndFees+"</p><h3>$"+b.TotalPrice+'</h3><a class="rent-link" href="'+b.DeepLink+'" target="_blank">Rent</a></div></div>')}),$.each(d.MetaData.CarMetaData.CarTypes,function(a,b){b.CarTypeCode;$('#results .result[data-car-type-code="'+b.CarTypeCode+'"] .result-col:first-of-type').after('<div class="car-type-details result-col"><h2>'+b.CarTypeName+"</h2><p>"+b.PossibleModels+"</p><p><strong>Features: </strong>"+b.PossibleFeatures+"</p><p><strong>Seating: </strong>"+b.TypicalSeating+"</p></div>")}),void $("body").scrollTo(".results-wrap",{duration:600,offset:-0})):(alert('There were was an problem processing you request.. The specific error was "'+StatusDesc+'"'),!1)},
